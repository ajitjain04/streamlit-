...
with open(r'D:\buddy session strreamlit\rfr.pkl', 'rb') as file:
    rfr = pickle.load(file)

rfc = joblib.load(r'D:\buddy session strreamlit\rfc.joblib')

df_ad = pd.read_csv(r'D:\buddy session strreamlit\Advertising.csv')
df_db = pd.read_csv(r'D:\buddy session strreamlit\diabetes2.csv')
